...
$LANG->includeLLFile('EXT:sduconnect/mod1/locallang.xml');
 ...
 */
class  tx_sduconnect_module1 extends t3lib_SCbase {
	var $pageinfo;
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/sduconnect/mod1/index.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/sduconnect/mod1/index.php']);
}
...
// Make instance:
$SOBE = t3lib_div::makeInstance('tx_sduconnect_module1');
$SOBE->init();
